...
class TestFileAccessApp extends StatelessWidget {
  const TestFileAccessApp({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const FileAccessTestPage(),
    );
  }
}

class FileAccessTestPage extends StatefulWidget {
  const FileAccessTestPage({super.key});

  @override
  State<FileAccessTestPage> createState() => _FileAccessTestPageState();
}

class _FileAccessTestPageState extends State<FileAccessTestPage> {
          ...
          Expanded(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    '选中文件: ${_selectedFilePath.split('/').last}',
